...
utils/lang/make_unk_lm.sh data/local/dict_charv1 exp/unk_lang_model

utils/prepare_lang.sh --unk-fst exp/unk_lang_model/unk_fst.txt data/local/dict_charv1 "<unk>" data/local/lang data/lang_unk
...
cp data/lang_sw1_tg/G.fst data/lang_unk/G.fst

exit 0;

utils/mkgraph.sh data/lang_unk exp/chain/e2e_ exp/tri3/graph_unk
