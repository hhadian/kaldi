...
config_to_layer = {
        ...
        'relu-power-batchnorm-layer' : xlayers.XconfigBasicLayer,
        ...
        'timeconv-relu-batchnorm-layer': xlayers.XconfigConvLayer,
        'shift-timeconv-relu-batchnorm-layer': xlayers.XconfigConvLayer,
        'shift-timeconv-relu-log-batchnorm-layer': xlayers.XconfigConvLayer,
