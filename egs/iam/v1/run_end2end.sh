...
if [ $stage -le 4 ]; then
  ...
  local/prepare_lang.sh --sil-prob 0.9999 \
  ...
  local/prepare_lang.sh --sil-prob 0.9999 data/local/dict_50k \
  ...
  local/prepare_lang.sh --unk-fst exp/unk_lang_model/unk_fst.txt \
